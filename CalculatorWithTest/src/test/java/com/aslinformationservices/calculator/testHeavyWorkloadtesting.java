...
class testHeavyWorkloadtestingTest {
	...
	void testHeavyWorkloadtesting() {
		...
		System.out.println("Total Execution Time for testHeavyWorkloadtesting: " +
				((endTime - startTime) / (1000 * 60)) + " minutes" + " or " + ((endTime - startTime) / (1000))
